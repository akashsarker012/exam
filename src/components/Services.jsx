  ...
  return (
    <div>
      ...
      <div className="flex justify-center items-center gap-8 mx-auto">
        {data.map((item, index) => (
          <div key={index} className={"flex group hover:bg-[#3639A4] flex-col duration-500 shadow-lg rounded-lg p-6 w-80 "}>
            <div className=' w-24 h-24  flex justify-center items-center rounded-full bg-[#E8FAF0]'>
            <img className=" w-12 h-12 " src={item.icon} alt="" srcset="" />
            </div>
